...
public class EntityFactory {
    ...
    public EntityFactory(JSONObject config) {
        this.config = config;
        this.mindControlDuration = config.optInt("mind_control_duration", 3);
        this.midnightArmourAttack = config.optDouble("midnight_armour_attack", 2);
        this.midnightArmourDefence = config.optDouble("midnight_armour_defence", 2);
    }
    ...
    public Assassin buildAssassin(Position pos) {
        ...
        double allyAttack = config.optDouble("ally_attack", Assassin.DEFAULT_ALLY_ATTACK);
        double allyDefence = config.optDouble("ally_defence", Assassin.DEFAULT_ALLY_DEFENCE);
